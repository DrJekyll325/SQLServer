...
hist(rbinom(n = 10000, size = 16, prob = 1.0000 - 0.0969), col = "red", breaks = 17, main = "10,000 Days For Dr. McCoy", xlab = "Number Of Arrivals");
...
dbinom(x = 15, size = 16, prob = 1.0000 - 0.0969);

##	What are the complete percentages for Dr. McCoy?
dbinom(x = 16:0, size = 16, prob = 1.0000 - 0.0969);

##	Are 16/16 people really going to show up over 19% of the time?
(1.0000 - 0.0969) ^ 16;


##	Range percentages
##	What is the probability that more than 14 of the 16 patients show up?
pbinom(q = 14, size = 16, prob = 1.0000 - 0.0969, lower.tail = FALSE);

##	What is the probability that 14 or fewer of the 16 patients show up?
pbinom(q = 14, size = 16, prob = 1.0000 - 0.0969, lower.tail = TRUE);
...
1 - pbinom(q = 13, size = 16, prob = 1.0000 - 0.0969, lower.tail = TRUE);
...
qbinom(p = 0.90, size = 16, prob = 1.0000 - 0.0969, lower.tail = TRUE);
...
dbinom(x = 32:0, size = 32, prob = 1.0000 - 0.2590);


##	Modeling Dr. Quinn's Distribution
hist(rbinom(n = 10000, size = 32, prob = 1.0000 - 0.2590), col = "red", breaks = 17, main = "10,000 Days For Dr. Quinn", xlab = "Number Of Arrivals");

##	How many people will show up on the 90th percentile of Dr. Quinn's distribution?
qbinom(p = 0.90, size = 32, prob = 1.0000 - 0.2590, lower.tail = TRUE);
