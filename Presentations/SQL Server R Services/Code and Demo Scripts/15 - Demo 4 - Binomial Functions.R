...
hist(rbinom(n = 10000, size = 16, prob = 1.0000 - 0.0981), col = "red", breaks = 17, main = "10,000 Days For Dr. McCoy", xlab = "Number Of Arrivals");
...
dbinom(x = 15, size = 16, prob = 1.0000 - 0.0981);

##	What are the complete percentages for Dr. McCoy?
dbinom(x = 16:0, size = 16, prob = 1.0000 - 0.0981);

##	Are 16/16 people really going to show up nearly 18% of the time?
(1.0000 - 0.0981) ^ 16;


##	Range percentages
##	What is the probability that more than 14 of the 16 patients show up?
pbinom(q = 14, size = 16, prob = 1.0000 - 0.0981, lower.tail = FALSE);

##	What is the probability that 14 or fewer of the 16 patients show up?
pbinom(q = 14, size = 16, prob = 1.0000 - 0.0981, lower.tail = TRUE);
...
1 - pbinom(q = 13, size = 16, prob = 1.0000 - 0.0981, lower.tail = TRUE);
...
qbinom(p = 0.90, size = 16, prob = 1.0000 - 0.0981, lower.tail = TRUE);
...
dbinom(x = 32:0, size = 32, prob = 1.0000 - 0.2561);

##	How many people will show up on the 90th percentile of Dr. Quinn's distribution?
qbinom(p = 0.90, size = 32, prob = 1.0000 - 0.2561, lower.tail = TRUE);
