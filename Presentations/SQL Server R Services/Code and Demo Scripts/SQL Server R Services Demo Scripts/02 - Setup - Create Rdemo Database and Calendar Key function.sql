...
BEGIN
	...
	(
		NAME = N'RDemo',
		FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\RDemo.mdf',
		SIZE = 2048000KB,
		MAXSIZE = UNLIMITED,
		FILEGROWTH = 256000KB
	)
	...
	(
		NAME = N'RDemo_log',
		FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\RDemo_log.ldf',
		SIZE = 2048000KB,
		MAXSIZE = UNLIMITED,
